...
p = Product.create!(price: 1, description: "For when life gives you lemons. This zesty lemon tincture has a refreshing twist that we are sure you will enjoy.", name: 'cbd oils', photo: open("http://res.cloudinary.com/dq2kcu9ey/image/upload/v1543755363/pqje5y6qblpza9f4cxdn.jpg"))
Product.create!(price: 3, description: "Savour our smooth tasting orange flavour reminiscent of a freshly squeezed glass of OJ. ", name: 'cbd capsules', photo: open("http://res.cloudinary.com/dq2kcu9ey/image/upload/v1543755363/pqje5y6qblpza9f4cxdn.jpg"))
Product.create!(price: 2, description: "For those with a sweet tooth. Indulge in our chocolate tincture, one of the first on the market that we are sure you will enjoy.", name: 'cbd balms', photo: open("http://res.cloudinary.com/dq2kcu9ey/image/upload/v1543755363/pqje5y6qblpza9f4cxdn.jpg"))
...
Review.create!(photo: photo, product_id: p.id, user_id: user.id, name: "Tom", position: "PE Teacher", content: "Help with leep patterns")
...
Review.create!(photo: photo, product_id: p.id, user_id: user.id, name: "Chris Dicomidis", position: "International rugby player", content: "Knee Ligament Recovery")
