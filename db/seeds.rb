...
capsule_desc = "Our cbd capsules contain high-quality, full-spectrum and co2 extracted hemp. We infused it in coconut oil before capping in vegan capsules. They are easy-to-use and slow-to-absorb, great for when you only need a small amount of cbd product over a longer period of time. Designed to help you support and maintain an active lifestyle."
